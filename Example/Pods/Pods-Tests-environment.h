...
#define COCOAPODS_POD_AVAILABLE_JDFNavigationBarActivityIndicator
#define COCOAPODS_VERSION_MAJOR_JDFNavigationBarActivityIndicator 0
#define COCOAPODS_VERSION_MINOR_JDFNavigationBarActivityIndicator 1
#define COCOAPODS_VERSION_PATCH_JDFNavigationBarActivityIndicator 0
